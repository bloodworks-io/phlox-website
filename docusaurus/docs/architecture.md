...
- **Vector DB:** [sqlite-vec](https://github.com/asg017/sqlite-vec) (local, in the same database).
...
- Local file-based storage, encrypted at rest.
...
### RAG (sqlite-vec)
- Vector database for document storage, co-located in the SQLite database.
